...
const IndexPage = () => {
  return (
    <Layout pageTitle="Home Page">
      <p className="intro">
        Welcome to our blog! We're excited to share our thoughts and ideas with
        you on a variety of topics, from lifestyle and food to international
        news and events. Take a look around and let us know what you think.
      </p>
      ...
      <div className="container">
        <section className="lifestyle-section">
          ...
          <div>
            <p>
              Discover the latest trends and tips on living your best life. From
              fashion and beauty to health and wellness, our Lifestyle blog has
              it all.
            </p>
            <StaticImage
              className="my-image"
        ...
        <section className="food-section">
          ...
          <div>
            <p>
              ...
              adventures. Explore new flavors and cuisines with our Food related
              blog.
            </p>
            <StaticImage
              className="my-image"
        ...
        <section className="international-section">
          ...
          <div>
            <p>
              ...
              world. Our International blog covers politics, culture, and more.
            </p>
            <StaticImage
              className="my-image"
              alt="Clifford, a reddish-brown pitbull, posing on a couch and looking stoically at the camera"
        ...
        <section className="saudi-arabia-section">
          ...
          <div>
            <p>
              ...
              local news and events to travel and culture, our Saudi Arabia blog
              has you covered.
            </p>
            <StaticImage
              className="my-image"
        ...
        <section className="games-section">
          ...
          <div> 
            <p> 
              Get your game on with our Games blog. From reviews and previews to 
              tips and tricks, we've got everything you need to level up your 
              gaming experience. 
            </p> 
            <StaticImage 
              className="my-image" 
